<%-- 
    Document   : AddClassroomForm
    Created on : Jul 23, 2018, 9:23:17 PM
    Author     : OJAS MODI
--%>
    ...
    <body>
        ...
        <div class="jumbotron jumbotron-fluid">
            <div class="container">
                ...
                <h1 class="display-4">Classroom form-</h1>
            </div>
        </div>
        <div class='container'><form action="AddClassroom.jsp">
                <div class="form-group row justify-content-center">
                    <label for="inputEmail3" class="col-sm-2 col-form-label">Classroom No.:</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="cno" placeholder="Classroom no.">
                    </div>
                </div>
                <div class="form-group row justify-content-center">
                    <label for="inputPassword3" class="col-sm-2 col-form-label">Capacity:</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="capacity" placeholder="No.OfStudents">
                    </div>
                </div>
                <div class="form-group row justify-content-center">
                    <div class="col-1">
